...
# ex: ./scripts/cloud_run_deploy.sh gp2-release-terra us-central1 genotracker@gp2-release-terra.iam.gserviceaccount.com
...
gcloud run deploy genotracker-streamlit \
  --image us-central1-docker.pkg.dev/gp2-release-terra/genotools/genotracker-streamlit \
  --platform managed \
  --region us-central1 \
